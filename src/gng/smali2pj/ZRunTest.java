...
public class ZRunTest{
	...
	public static void main(String[] args) throws IOException{
		...
		*/		
		...
		test("9B: add-long", 			"add-long v3, v5, v7",		"v3(,v4) = v5(,v6) + v7(,v9);");
		test("9C: sub-long", 			"sub-long v3, v5, v7",		"v3(,v4) = v5(,v6) - v7(,v9);");
		test("9D: mul-long", 			"mul-long v3, v5, v7",		"v3(,v4) = v5(,v6) * v7(,v9);");
		test("9E: div-long", 			"div-long v3, v5, v7",		"v3(,v4) = v5(,v6) / v7(,v9);");
		test("9F: rem-long", 			"rem-long v3, v5, v7",		"v3(,v4) = v5(,v6) % v7(,v9);");
		test("A0: and-long", 			"and-long v3, v5, v7",		"v3(,v4) = v5(,v6) & v7(,v9);");
		test("A1: or-long", 			"or-long v3, v5, v7",		"v3(,v4) = v5(,v6) | v7(,v9);");
		test("A2: xor-long", 			"xor-long v3, v5, v7",		"v3(,v4) = v5(,v6) ^ v7(,v9);");
		test("A3: shl-long", 			"shl-long v3, v5, v7",		"v3(,v4) = v5(,v6) << v7(,v9);");
		test("A4: shr-long", 			"shr-long v3, v5, v7",		"v3(,v4) = v5(,v6) >> v7(,v9);");
		test("A5: ushr-long", 			"ushr-long v3, v5, v7",		"v3(,v4) = v5(,v6) >>> v7(,v9);");		
		...
		test("AB: add-double", 			"add-double v3, v5, v7",	"v3(,v4) = v5(,v6) + v7(,v9);");
		test("AC: sub-double", 			"sub-double v3, v5, v7",	"v3(,v4) = v5(,v6) - v7(,v9);");
		test("AD: mul-double", 			"mul-double v3, v5, v7",	"v3(,v4) = v5(,v6) * v7(,v9);");
		test("AE: div-double", 			"div-double v3, v5, v7",	"v3(,v4) = v5(,v6) / v7(,v9);");
		test("AF: rem-double", 			"rem-double v3, v5, v7",	"v3(,v4) = v5(,v6) % v7(,v9);");
